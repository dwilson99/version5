...
#save raw classification data
	...
	for trainingSet in trainingSets:
		...
		for traininglabel in trainingLabels:
			print('602 traininglabel: ', traininglabel)
...
#				 print(memorySpec)
				...
				def memorySpecLoop():
					ii = 0
					items_count = 0
					print('1455 trainingSet: ', trainingSet)
			...
			#				 print "and it has %i freqncy and %f tf" % (odf,otf)
						...
						if (items_count == 0):
							print('1472 df: ', df)
							print('1473 otherSample: ', otherSample)
							print('1474 memorySpec[spec_area]: ',memorySpec['spec_area'])
