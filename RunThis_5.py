...
import harvestExpLearn56ok as harvest
...
#        Frame.__init__(self, master)
        self.window = master
        self.pickle_db_name = "pickle_db_5ok"
        self.script_path = ''
#         self.trainingSets = ''
...
#            self.number_training_files_as_string = str( len(self.trainingSets))
            ...
            print("RT 151 number of elements: ", number_training_files_as_str)
...
#             self.main_large_text_field.insert(tk.END, file_path +"\n")
    ...
    def run_harvest(self):
        ...
        print("RunThis 335 self.stopwords_file_path  :", self.stopwords_file_path)
#         text = self.main_large_text_field.get(1.0, tk.END)
        self.main_large_text_field.replace(1.0, tk.END, "Running the calculation...")
